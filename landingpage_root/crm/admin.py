...
class OrderAdm(admin.ModelAdmin):
    list_display = ('id', 'order_name', 'order_status', 'order_phone', 'oder_dt')
    list_display_links = ('id', 'order_name')
    search_fields = ('id', 'order_name', 'order_phone', 'oder_dt')
    list_filter = ('order_status',)
    list_editable = ('order_status', 'order_phone')
    list_per_page = 10
    list_max_show_all = 100
    fields = ('id', 'order_status', 'oder_dt', 'order_name', 'order_phone',)
    readonly_fields = ('id', 'oder_dt')
    inlines = [Coment,]
